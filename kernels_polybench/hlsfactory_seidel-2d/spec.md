...
- Benchmark name: `hlsfactory_seidel-2d`.
- Required HLS wrapper top function: `kernel_seidel_2d`.
- Include `seidel-2d.h` exactly once and reuse its declarations.
- Header-declared functions available for reuse: `kernel_seidel_2d`.
- Functions already defined in the plain input whose names/signatures should be preserved unless wrapping is required: `kernel_seidel_2d`.
