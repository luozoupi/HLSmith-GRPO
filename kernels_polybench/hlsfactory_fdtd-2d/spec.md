...
- Benchmark name: `hlsfactory_fdtd-2d`.
- Required HLS wrapper top function: `kernel_fdtd_2d`.
- Include `fdtd-2d.h` exactly once and reuse its declarations.
- Header-declared functions available for reuse: `kernel_fdtd_2d`.
- Functions already defined in the plain input whose names/signatures should be preserved unless wrapping is required: `kernel_fdtd_2d`.
