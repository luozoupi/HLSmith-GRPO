...
- Benchmark name: `hlsfactory_jacobi-2d`.
- Required HLS wrapper top function: `kernel_jacobi_2d`.
- Include `jacobi-2d.h` exactly once and reuse its declarations.
- Header-declared functions available for reuse: `kernel_jacobi_2d`.
- Functions already defined in the plain input whose names/signatures should be preserved unless wrapping is required: `kernel_jacobi_2d`.
