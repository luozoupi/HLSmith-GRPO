...
- Benchmark name: `hlsfactory_correlation`.
- Required HLS wrapper top function: `kernel_correlation`.
- Include `correlation.h` exactly once and reuse its declarations.
- Header-declared functions available for reuse: `kernel_correlation`.
- Functions already defined in the plain input whose names/signatures should be preserved unless wrapping is required: `kernel_correlation`.
