...
- Benchmark name: `hlsfactory_syrk`.
- Required HLS wrapper top function: `kernel_syrk`.
- Include `syrk.h` exactly once and reuse its declarations.
- Header-declared functions available for reuse: `kernel_syrk`.
- Functions already defined in the plain input whose names/signatures should be preserved unless wrapping is required: `kernel_syrk`.
